...
5. **Engram Sync Hygiene**: For release-ready milestones (main branch promotions, version bumps), run `engram sync` and commit generated memory chunks when the team workflow uses shared Engram history.
